...
**Godoc:** https://godoc.org/github.com/mceachsamu/sentry-go/iris

**Example:** https://github.com/mceachsamu/sentry-go/tree/master/example/iris

## Installation

```sh
go get github.com/mceachsamu/sentry-go/iris
```
...
`sentryiris` attaches an instance of `*sentry.Hub` (https://godoc.org/github.com/mceachsamu/sentry-go#Hub) to the `iris.Context`, which makes it available throughout the rest of the request's lifetime.
