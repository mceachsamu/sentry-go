...
[![Build Status](https://github.com/mceachsamu/sentry-go/workflows/go-workflow/badge.svg)](https://github.com/mceachsamu/sentry-go/actions?query=workflow%3Ago-workflow)
[![Go Report Card](https://goreportcard.com/badge/github.com/mceachsamu/sentry-go)](https://goreportcard.com/report/github.com/mceachsamu/sentry-go)
[![Discord](https://img.shields.io/discord/621778831602221064)](https://discord.gg/Ww9hbqr)
[![GoDoc](https://godoc.org/github.com/mceachsamu/sentry-go?status.svg)](https://godoc.org/github.com/mceachsamu/sentry-go)
[![go.dev](https://img.shields.io/badge/go.dev-pkg-007d9c.svg?style=flat)](https://pkg.go.dev/github.com/mceachsamu/sentry-go)
...
```console
$ go get github.com/mceachsamu/sentry-go@latest
```

Check out the [list of released versions](https://github.com/mceachsamu/sentry-go/releases).

## Configuration

To use `sentry-go`, you’ll need to import the `sentry-go` package and initialize
it with your DSN and other [options](https://pkg.go.dev/github.com/mceachsamu/sentry-go#ClientOptions).
...
We also provide a [complete API reference](https://pkg.go.dev/github.com/mceachsamu/sentry-go).
...
- [Bug Tracker](https://github.com/mceachsamu/sentry-go/issues)
- [GitHub Project](https://github.com/mceachsamu/sentry-go)
- [![GoDoc](https://godoc.org/github.com/mceachsamu/sentry-go?status.svg)](https://godoc.org/github.com/mceachsamu/sentry-go)
- [![go.dev](https://img.shields.io/badge/go.dev-pkg-007d9c.svg?style=flat)](https://pkg.go.dev/github.com/mceachsamu/sentry-go)
- [![Documentation](https://img.shields.io/badge/documentation-sentry.io-green.svg)](https://docs.sentry.io/platforms/go/)
- [![Discussions](https://img.shields.io/github/discussions/getsentry/sentry-go.svg)](https://github.com/mceachsamu/sentry-go/discussions)
- [![Discord](https://img.shields.io/discord/621778831602221064)](https://discord.gg/Ww9hbqr)
