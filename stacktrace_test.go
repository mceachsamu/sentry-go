...
func TestSplitQualifiedFunctionName(t *testing.T) {
	tests := []struct {
		...
		{
			"github.com/mceachsamu/sentry-go.Init",
			"github.com/mceachsamu/sentry-go",
			"Init",
		},
		{
			"github.com/mceachsamu/sentry-go.(*Hub).Flush",
			"github.com/mceachsamu/sentry-go",
			"(*Hub).Flush",
		},
		{
			"github.com/mceachsamu/sentry-go.Test.func2.1.1",
			"github.com/mceachsamu/sentry-go",
			"Test.func2.1.1",
		},
		{
		...
		// considered outside of the SDK and thus included (useful for testing)
		{
			in: []Frame{
				...
				},
				{
					...
					Module:   "github.com/mceachsamu/sentry-go_test",
			...
			in: []Frame{
				{
					...
					Module:   "github.com/mceachsamu/sentry-go/http/integration",
					AbsPath:  "/somewhere/sentry/sentry-go/http/integration/integration.go",
					InApp:    true,
				},
				{
					Function: "(*Handler).Handle",
					Module:   "github.com/mceachsamu/sentry-go/http",
